...
def connect_to_twitter(kafkaProducer, tracks):
    api_key = "N3BhfveA3Q4mXCtyRRphCrC7v"                                     #  different data needs to be fill here from twitter
    api_secret = "6UFnndGzuMwKKIldE2kw9syulo3Hb4gVwQ14umDP43jTdv9x1s"         #  different data needs to be fill here from twitter

    access_token = "368413415-5FaufzgFTozESYU00xp6nxrxoiUUp1IIhThVHHOp"       #  different data needs to be fill here from twitter
    access_token_secret = "c1JV2hFifKz2WFiLxLnpfrBPqmgeBLH5kBk5mqeq8PF9B"     #  different data needs to be fill here from twitter
